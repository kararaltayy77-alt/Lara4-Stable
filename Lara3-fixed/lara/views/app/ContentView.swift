    ...
    var body: some View {
        NavigationStack {
            ...
            .sheet(isPresented: $showSettings) {
              ...
              .sheet(isPresented: $mgr.showTerminal) {
                  NavigationStack {
                      TerminalView()
                  }
              }
